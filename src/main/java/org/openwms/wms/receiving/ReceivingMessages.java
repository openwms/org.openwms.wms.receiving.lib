...
public final class ReceivingMessages {
    ...
    public static final String TU_TYPE_NOT_GIVEN = "owms.wms.rec.tuTypeNotGiven";
    public static final String LOCATION_ID_NOT_GIVEN = "owms.wms.rec.locationIdNotGiven";
