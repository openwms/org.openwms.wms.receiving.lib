...
insert into WMS_REC_ORDER_POSITION (c_pk,c_order_id,c_pos_no,c_state,C_QTY_EXPECTED_TYPE,C_QTY_EXPECTED,c_sku,c_ol,c_created) values (1000,100,'1','CREATED','PC@org.openwms.core.units.api.PieceUnit','1','C1',0,now());
