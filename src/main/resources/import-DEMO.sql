...
insert into WMS_REC_ORDER_POSITION (c_pk,c_disc,c_order_id,c_pos_no,c_state,C_QTY_EXPECTED_TYPE,C_QTY_EXPECTED,C_QTY_RECEIVED_TYPE,C_QTY_RECEIVED,c_sku,c_ol,c_created) values (1000, 'EXPQTY','T4711','1','CREATED','PC@org.openwms.core.units.api.Piece','1','PC@org.openwms.core.units.api.Piece','0','C1',0,now());
insert into WMS_REC_ORDER_POSITION (c_pk,c_disc,c_order_id,c_pos_no,c_state,C_QTY_EXPECTED_TYPE,C_QTY_EXPECTED,C_QTY_RECEIVED_TYPE,C_QTY_RECEIVED,c_sku,c_ol,c_created) values (1001, 'EXPQTY','T4711','2','CREATED','DOZ@org.openwms.core.units.api.Piece','2','PC@org.openwms.core.units.api.Piece','0','C2',0,now());
