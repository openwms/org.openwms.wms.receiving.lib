...
insert into WMS_REC_ORDER_POS_PRODUCT (c_pk,c_order_id,c_pos_no,c_state,C_QTY_EXPECTED_TYPE,C_QTY_EXPECTED,C_QTY_RECEIVED_TYPE,C_QTY_RECEIVED,c_sku,c_ol,c_created) values (1001,'T4711','2','CREATED','PC@org.openwms.core.units.jsr385.api.Each','2','PC@org.openwms.core.units.jsr385.api.Each','0','C2',0,now());
